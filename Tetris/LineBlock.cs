...
namespace Tetris
{
    class LineBlock : Tetrimino
    {
        public LineBlock(System.Windows.Controls.Canvas gameCanvas, GameArray gameArray)
        {
            this.Type = "Line";
            this.CanMove = true;
        ...
        public override int[] GenerateXArray(int x, int orientation)
        {
            ...
            {
                return new int[] { x - 40, x - 20, x, x + 20 };
            }
        ...
        public override int[] GenerateYArray(int y, int orientation)
        {
            if (orientation == 0)
            {
                return new int[] { y - 20, y - 20, y + 20, y + 40 };
            }
            else if (orientation == 1)
            {
        ...
        public override void DrawBlock(int x, int y)
        {
            ...
            fillBrush.Color = Color.FromArgb(255, 240, 140, 30);
        ...
        public override void PlaceBlock(int x, int y)
        {
            ...
            SolidColorBrush fillBrush = new SolidColorBrush();
            SolidColorBrush strokeBrush = new SolidColorBrush();
            fillBrush.Color = Color.FromArgb(255, 160, 90, 20);
            strokeBrush.Color = Color.FromArgb(255, 1, 1, 0);
            rect.Height = 20;
            rect.Width = 20;
            rect.StrokeThickness = 1;
